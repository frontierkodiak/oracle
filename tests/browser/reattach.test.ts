...
describe("resumeBrowserSession", () => {
  test.each([undefined, { desiredModel: "Latest", thinkingTime: "pro" as const }])(
    "selects the saved target and captures markdown with config %j",
    async (modelConfig) => {
      const runtime = {
        chromePort: 51559,
